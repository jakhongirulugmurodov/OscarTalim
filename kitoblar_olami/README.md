...
| **Juma aksiyasi** | Ikki turi bor: **foizli chegirma** (masalan, −20%) yoki **1+1** (aksiyadagi kitoblar narx bo'yicha tartiblanadi, har ikkinchisi — arzonrog'i — bepul). Admin aksiyani kiritadi va chegirmaga tushadigan kitoblarni tanlaydi → bot aksiyani **1 hafta oldin** (o'tgan juma soat 10:00 da) hammaga e'lon qiladi, aksiya kuni yana eslatadi va chegirmani o'sha kitoblarga avtomatik qo'llaydi. Aksiyadagi kitoblar ro'yxati mijozlarga ham ko'rinadi: e'lon matnida, «🎉 Juma aksiyasi» bo'limida va «📚 Aksiyadagi kitoblarni ko'rish» tugmasi orqali (savatchaga qo'shish mumkin). Keyingi juma uchun aksiya kiritilmagan bo'lsa, adminlarga oldindan eslatadi |
